...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link <?= $kernel->router()->is_name('admin') ? 'active': '' ?>" aria-current="page" href="/admin">
        ...
        <ul class="nav flex-column mt-2 mb-2">
            <li class="nav-item">
                <a class="nav-link <?= $kernel->router()->is_name('admin_films') ? 'active': '' ?>" href="/admin/films">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $kernel->router()->is_name('admin_actors') ? 'active': '' ?>" href="/admin/actors">
        ...
        <ul class="nav flex-column mt-2 mb-2">
            <li class="nav-item">
                <a class="nav-link <?= $kernel->router()->is_name('admin_import_films') ? 'active': '' ?>" href="/admin/import_films">
